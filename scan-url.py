...
if len(sys.argv) == 2:
	...
	print("Scanning: '" + sys.argv[1] + "' https_port: '" + sys.argv[2] + "'" + "' path: '" + sys.argv[3] + "' cookiekey: '" + sys.argv[4] + "' cookievalue: '" + sys.argv[5] + "'")
	print(json.dumps(scan(sys.argv[1], https_port=sys.argv[2], path=sys.argv[3], cookies={sys.argv[4]: sys.argv[5]}), sort_keys=True, indent=2))
else:
